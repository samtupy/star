# Slightly modified version of wxasync which causes the asyncio loop to sleep a lot less, providing for a faster UI experience within the STAR client.
            ...
            while not self.exiting:
                if IS_MAC:
                    ...
                    while evtloop.Pending():
                        ...
                        self.ui_idle = False
                await asyncio.sleep(self.sleep_duration if self.sleep_counter == 100 else 0)
                self.sleep_counter += 1
                if self.sleep_counter > 100: self.sleep_counter = 0
