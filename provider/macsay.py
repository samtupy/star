...
star_provider("macsay", voices = voices, synthesis_process = ["say", "-o", "{filename}", "--data-format=LEI16@32000", "-v", "{voice}", "{text}"], synthesis_process_rate = ["-r", "{rate}"], synthesis_default_rate = 190)
